...
INSERT INTO CLIENTDETAILS 
    ...
    SELECT * FROM (SELECT 'forsrc' APPID, null RESOURCEIDS, 'forsrc' APPSECRET, 'read,write' SCOPE, 'password,authorization_code,refresh_token,implicit,client_credentials' GRANTTYPES,
...
INSERT INTO oauth_client_details
    ...
    SELECT * FROM (SELECT 'forsrc' client_id, null resource_ids, 'forsrc' client_secret, 'read,write' SCOPE, 'password,authorization_code,refresh_token,implicit,client_credentials' authorized_grant_types, null web_server_redirect_uri,
