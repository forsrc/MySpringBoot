...
@Component
public class Oauth2PreZuulFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        try {
            ...
            if (refreshToken != null) {
                ...
                ctx.setRequest(new Oauth2HttpServletRequest(req, param));
            }
    ...
    public class Oauth2HttpServletRequest extends HttpServletRequestWrapper {
        private final Map<String, String[]> additionalParams;
        private final HttpServletRequest request;

        public Oauth2HttpServletRequest(final HttpServletRequest request,
